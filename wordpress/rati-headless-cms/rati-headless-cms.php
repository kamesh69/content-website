...
if (!class_exists('Rati_Headless_CMS')) {
    final class Rati_Headless_CMS {
        ...
        public static function render_headless_settings_page() {
            if (!current_user_can('manage_options')) {
                return;
            }
            ?>
        ...
        public static function resolve_frontend_path($post_type, $slug, $post = null) {
            switch ($post_type) {
                case 'post':
                    return '/blog/' . $slug;
                case 'rati_project':
        ...
        public static function filter_cpt_link($link, $post) {
            if (!$post instanceof WP_Post) {
                return $link;
            }
            $path = self::resolve_frontend_path($post->post_type, $post->post_name, $post);
        ...
        public static function redirect_public_frontend() {
        ...
        public static function add_view_site_column($columns) {
            if (is_array($columns)) {
        ...
        public static function render_view_site_column($column, $post_id) {
        ...
        public static function on_post_status_transition($new_status, $old_status, $post) {
            if (!$post instanceof WP_Post || $new_status !== 'publish' || $old_status === 'publish') {
                return;
            }
        ...
        public static function send_newsletter_broadcast($post) {
            if (!$post instanceof WP_Post) {
                return;
            }
        ...
        public static function on_settings_updated($option, $old = null, $value = null) {
            if ($option === self::OPTION_KEY) {
                self::trigger_revalidation('site-settings');
            }
        }

        public static function trigger_revalidation($tag) {
        ...
        public static function register_rest_routes() {
            ...
            register_rest_route('rati/v1', '/site-settings', [
                'methods' => 'GET',
                'callback' => function() { return self::get_site_settings(); },
        ...
        public static function register_graphql() {
            ...
            register_graphql_field('RootQuery', 'ratiSiteSettings', [
                ...
                'resolve' => function() { return wp_json_encode(self::get_site_settings()); },
            ]);
        ...
        private static function register_cpt_graphql_fields($type, array $fields) {
